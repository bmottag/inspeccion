			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="alert alert-success alert-dismissible fade in" role="alert">
						<strong>Info:</strong> Formulario para adicionar y/o editar un inventario de Check In.
					</div>
...
<?php if($information){ //si hay informacion entonces mostramos boton para la firma ?>
							<li><br>
								<a href="<?php echo base_url("main/add_signature/checkin/" . $information[0]["id_inspeccion"] . "/". $userInfo[0]["id_user"] ); ?>" class="btn btn-info btn-block"><i class="fa fa-edit"></i> Firma del cliente</a>
							</li>
<?php } ?>
							
						</ul>
						
<?php if($information && $information[0]["firma"]){ //si hay firma la mostramos ?>
<img src="<?php echo base_url($information[0]["firma"]); ?>" class="img-rounded" alt="Firma cliente" width="224" height="156" />
<?php } ?>
