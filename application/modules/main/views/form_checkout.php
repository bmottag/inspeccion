...
<?php } ?>
					...
					<form id="form" data-parsley-validate class="form-horizontal form-label-left">
						...
						<input type="hidden" id="hddTipoInspeccion" name="hddTipoInspeccion" value="2"/>
						<input type="hidden" id="hddFKIdInspeccion" name="hddFKIdInspeccion" value="<?php echo $llaveForanea; ?>"/>
						
						<?php
							if($bandera){ //no hay chequeo es uno nuevo
						?>								
								<input type="hidden" id="hddIdInspeccion" name="hddIdInspeccion" value=""/>
						<?php
							}else{
								//si hay chequeo
						?>
